...
P2F main(V2P pixel)
{
    ...
    float3 local2 = LambertLighting(tangentLightDir, float3(0.000000f,0.000000f,1.000000f), MaterialAmbient.rgb, AmbientLight.rgb, LightColor[0].rgb, pixel.diffuse.rgb);
